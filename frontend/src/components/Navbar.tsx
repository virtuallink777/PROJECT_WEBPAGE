      ...
      <header className="relative bg-rose-300">
        <div className="border-b border-gray-500">
          <div className="flex h-24 items-center">
            ...
            <div className="flex ml-4 lg:ml-4">
              <Link href="/">
            ...
            <div className="ml-auto flex items-center">
              ...
              <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-3 mr-4">
                {user ? null : (
                ...
                {user ? null : (
                  <div className="flex lg:ml-2 lg:mr-4">
                    <span className="h-6 w-px bg-gray-500" aria-hidden="true" />
                  </div>
                )}

                <div className="flex lg:ml-2 lg:mr-2">
